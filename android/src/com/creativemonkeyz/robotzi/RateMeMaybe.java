...
import com.creativemonkeyz.robotzi.RateMeMaybeFragment.RMMFragInterface;
...
public class RateMeMaybe implements RMMFragInterface {
	...
	public RateMeMaybe(FragmentActivity activity) {
        ...
        setPromptMinimums(3, 2, 3, 2);

        setDialogTitle(activity.getString(R.string.rating_title));
        setDialogMessage(activity.getString(R.string.rating_message));

        setNegativeBtn(activity.getString(R.string.rating_button_negative));
        setNeutralBtn(activity.getString(R.string.rating_button_neutral));
        setPositiveBtn(activity.getString(R.string.rating_button_positive));
	}
